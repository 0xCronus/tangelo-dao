...
export default function Home() {
  return (
    <div className="px-32">
      ...
      />
      <div className="py-4 font-bold opacity-85">Explore DAOs</div>
      <div className="grid grid-cols-3 gap-4">
        <Link href="/gov/citrea-origins">
          <div className="bg-zinc-950 border border-gray-400 rounded-xl p-4">
            <div className="text-lg font-bold">Citrea Origins</div>
        ...
        <Link href="/gov/tangelo-dao">
          <div className="bg-zinc-950 border border-gray-400 rounded-xl p-4">
            ...
            <div className="flex items-center justify-center">
              <Image src="/logo.png" width={240} height={240} alt="Tangelo DAO"/>
            </div>
            <div className="text-sm opacity-75">
        ...
        <div className="bg-zinc-950 border border-gray-400 rounded-xl p-4">
          <div className="text-lg font-bold">More DAOs comming soon...</div>
          <div className="text-sm opacity-75">
            {/* Build Privacy-Focused DAOs for Inclusive BTC Communities */}
          </div>
        </div>
