          ...
          <Card className="bg-gray-950 border rounded-xl p-6">
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-gray-400">Proposal ID: {proposalData.id}</div>
                  <div className="text-sm text-gray-500">{new Date(proposalData.timestamp).toLocaleDateString()}</div>
                </div>
              </div>
          ...
          <div className="space-y-6 py-4">
            <RadioGroup value={selectedVote} onValueChange={(value: string) => setSelectedVote(value as VoteOption)}>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="against" className="text-white">Against</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="abstain" id="abstain" />
                <Label htmlFor="abstain" className="text-white">Abstain</Label>
              </div>
            </RadioGroup>
